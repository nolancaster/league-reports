...
class LeaguesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create league" do
    assert_difference('League.count') do
      post leagues_url, params: { league: { founded: @league.founded, name: @league.name, url: @league.url } }
    end
  ...
  test "should update league" do
    patch league_url(@league), params: { league: { founded: @league.founded, name: @league.name, url: @league.url } }
